...
const TrustedBy = () => {
  ...
  const EmptyCell = () => (
    <div className="aspect-square flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-[#e6ffe6]/30 rounded-2xl lg:rounded-3xl w-full">
    </div>
  );

  return (
    <section className="w-full py-6 sm:py-8 lg:py-12 bg-[#dbdbdb] rounded-2xl lg:rounded-3xl min-h-[400px] sm:min-h-[600px] lg:h-[800px]">
      <div className="mx-auto px-3 sm:px-4 h-full bg-[#ededed] rounded-xl pt-2" style={{ maxWidth: '1350px' }}>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-6 lg:gap-x-10 h-full mt-4 sm:mt-6 lg:mt-8 max-w-[400px] sm:max-w-none mx-auto">
          {/* Title */}
          <div className="col-span-2 sm:col-span-3 lg:col-span-2 flex items-start p-4 sm:p-6 lg:p-8 bg-[#e6ffe6]/30 border-2 border-[#2d3436]/20 rounded-2xl lg:rounded-3xl">
